...
ParticleSystemUI::ParticleSystemUI() {
  fltk::DoubleBufferWindow* w;
   {fltk::DoubleBufferWindow* o = mFLWindow = new fltk::DoubleBufferWindow(649, 665, "Particle Systems");
    w = o;
    o->type(241);
    ...
    o->begin();
     {fltk::Group* o = mControlGrp = new fltk::Group(3, 520, 640, 145);
    }
     {fltk::Group* o = new fltk::Group(3, 3, 640, 47, "Menu Button");
     ...
     {WindowGLDisplay* o = mGLWindow = new WindowGLDisplay(3, 48, 640, 480);
